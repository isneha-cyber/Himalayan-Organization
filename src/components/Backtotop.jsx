...
const BacktoTop = () => {
    ...
    const openWhatsApp = () => {
        const phoneNumber = '+977 061-523848';
    ...
    return (
        <>
            <style>{`
                ...
                .whatsapp-blinker       { animation: whatsapp-pulse 2s infinite; }
                .whatsapp-icon-blinker  { animation: whatsapp-glow  1.5s ease-in-out infinite; }
            ...
            {/* Fixed container — stacks both buttons vertically */}
            <div className="fixed bottom-8 right-8 z-50 flex flex-col items-center gap-3">



  {/* WhatsApp — always visible, always at bottom */}
                <button
                ...
                >
                    <span className="whatsapp-notification" />
                    ...
                    <div className="absolute inset-0 rounded-full bg-green-500 opacity-0 group-hover:opacity-20 blur-xl transition-opacity duration-300" />
                </button>
                {/* Back to Top — sits on top when visible */}
                {isVisible && (
                    <button
                        onClick={scrollToTop}
                        className="
                    ...
                    >
                        <div className="absolute inset-0.5 bg-[#c4a787] text-white border border-white rounded-full flex items-center justify-center">
                            <svg
                        ...
                        <div className="absolute inset-0 rounded-full bg-[#c4a787] opacity-0 group-hover:opacity-20 blur-xl transition-opacity duration-300" />
                    </button>
                )}
